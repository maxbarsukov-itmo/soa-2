    ...
    for (FilterRuleDto rule : criteria.getFilters()) {
      ...
      switch (operator) {
        ...
        case "ne":
          ...
          break;
        case "gt":
          rulePredicate = cb.greaterThan((jakarta.persistence.criteria.Expression<? extends Comparable>) path, (Comparable) parsedValue);
          break;
        case "lt":
          rulePredicate = cb.lessThan((jakarta.persistence.criteria.Expression<? extends Comparable>) path, (Comparable) parsedValue);
          break;
        case "gte":
          rulePredicate = cb.greaterThanOrEqualTo((jakarta.persistence.criteria.Expression<? extends Comparable>) path, (Comparable) parsedValue);
          break;
        case "lte":
          rulePredicate = cb.lessThanOrEqualTo((jakarta.persistence.criteria.Expression<? extends Comparable>) path, (Comparable) parsedValue);
          break;
        default:
